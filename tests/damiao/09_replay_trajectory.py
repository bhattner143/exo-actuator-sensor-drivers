"""09 - Replay a recorded trajectory via DamiaoBus.

Loads demo_trajectory.csv (from 08_kinesthetic_record.py) and tracks it
with stiffer gains using ``bus.write("goal_position", ...)``.
"""
import sys
import os
import csv
