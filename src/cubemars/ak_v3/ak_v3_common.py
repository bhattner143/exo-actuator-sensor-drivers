...
CUBEMARS_AK_V3_LIMITS: dict[str, CubeMarsAkV3Limits] = {
    "AK10-9":  CubeMarsAkV3Limits(v_min=-28.0,  v_max=28.0,  t_min=-54.0,  t_max=54.0),
    "AK60-6":  CubeMarsAkV3Limits(v_min=-60.0,  v_max=60.0,  t_min=-12.0,  t_max=12.0),
    "AK70-9":  CubeMarsAkV3Limits(v_min=-30.0,  v_max=30.0,  t_min=-32.0,  t_max=32.0),
    "AK80-9":  CubeMarsAkV3Limits(v_min=-65.0,  v_max=65.0,  t_min=-18.0,  t_max=18.0),
    "AKE60-8": CubeMarsAkV3Limits(v_min=-40.0,  v_max=40.0,  t_min=-15.0,  t_max=15.0),
    "AKE80-8": CubeMarsAkV3Limits(v_min=-20.0,  v_max=20.0,  t_min=-35.0,  t_max=35.0),
}
